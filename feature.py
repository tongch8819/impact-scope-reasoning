...
class Feature:
    ...
    def get_probs_train(self, prob_flag="pcrw-exact", walker_num=50):  # calculate path feature
            ...
            for s, data in enumerate(datas):
                ...
                if node_1 not in self.nodes.keys():
                    ...
                    for path in self.relation_paths:
                        print('---------')
                        print('self.relation_paths: ', self.relation_paths)
...
if __name__ == "__main__":
    ...
    if args.action == 'train':
        ...
        feature.get_probs_train(prob_flag="pcrw-exact")
